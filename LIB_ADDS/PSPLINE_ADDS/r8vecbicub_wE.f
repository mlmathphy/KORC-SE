      subroutine r8vecbicub_wE(ictA,ictE,ivec,xvec,yvec,ivd,fvalA,
     >   fvalE,nx,xpkg,ny,ypkg,fsplA,fsplE,inf2,
     >   iwarn,ier)
c
...
c input:
      ...
      REAL*8 fsplE(0:3,inf2,ny) ! (compact) spline coefficients
c
c output:
...
c
     ...
     >     hx,hxi,hy,hyi,fsplA,inf2,ny)
      call r8fvbicub(ictE,ivec,ivd,fvalE,ix,iy,dxn,dyn,
     >     hx,hxi,hy,hyi,fsplE,inf2,ny)
c
      return
      end

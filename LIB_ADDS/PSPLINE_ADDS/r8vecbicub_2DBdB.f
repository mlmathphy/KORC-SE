      subroutine r8vecbicub_2DBdB(ict,ivec,xvec,yvec,ivd,
     >     fvalBR,fvalBPHI,fvalBZ,
     >     fvaldBRdR,fvaldBPHIdR,fvaldBZdR,
...
c input:
      ...
      REAL*8 fspldBRdR(0:3,inf2,ny) ! (compact) spline coefficients
      REAL*8 fspldBPHIdR(0:3,inf2,ny)! (compact) spline coefficients
      REAL*8 fspldBZdR(0:3,inf2,ny) ! (compact) spline coefficients
      REAL*8 fspldBRdPHI(0:3,inf2,ny) ! (compact) spline coefficients
      REAL*8 fspldBPHIdPHI(0:3,inf2,ny)! (compact) spline coefficients
      REAL*8 fspldBZdPHI(0:3,inf2,ny) ! (compact) spline coefficients
      REAL*8 fspldBRdZ(0:3,inf2,ny) ! (compact) spline coefficients
      REAL*8 fspldBPHIdZ(0:3,inf2,ny)! (compact) spline coefficients
      REAL*8 fspldBZdZ(0:3,inf2,ny)  ! (compact) spline coefficients
...
c
     ...
     >     hx,hxi,hy,hyi,fsplBZ,inf2,ny)
      call r8fvbicub(ict,ivec,ivd,fvaldBRdR,ix,iy,dxn,dyn,
     >     hx,hxi,hy,hyi,fsplBR,inf2,ny)
      call r8fvbicub(ict,ivec,ivd,fvaldBPHIdR,ix,iy,dxn,dyn,
     >     hx,hxi,hy,hyi,fsplBPHI,inf2,ny)
      call r8fvbicub(ict,ivec,ivd,fvaldBZdR,ix,iy,dxn,dyn,
     >     hx,hxi,hy,hyi,fsplBZ,inf2,ny)
      call r8fvbicub(ict,ivec,ivd,fvaldBRdPHI,ix,iy,dxn,dyn,
     >     hx,hxi,hy,hyi,fsplBR,inf2,ny)
      call r8fvbicub(ict,ivec,ivd,fvaldBPHIdPHI,ix,iy,dxn,dyn,
     >     hx,hxi,hy,hyi,fsplBPHI,inf2,ny)
      call r8fvbicub(ict,ivec,ivd,fvaldBZdPHI,ix,iy,dxn,dyn,
     >     hx,hxi,hy,hyi,fsplBZ,inf2,ny)
      call r8fvbicub(ict,ivec,ivd,fvaldBRdZ,ix,iy,dxn,dyn,
     >     hx,hxi,hy,hyi,fsplBR,inf2,ny)
      call r8fvbicub(ict,ivec,ivd,fvaldBPHIdZ,ix,iy,dxn,dyn,
     >     hx,hxi,hy,hyi,fsplBPHI,inf2,ny)
      call r8fvbicub(ict,ivec,ivd,fvaldBZdZ,ix,iy,dxn,dyn,
     >     hx,hxi,hy,hyi,fsplBZ,inf2,ny)      

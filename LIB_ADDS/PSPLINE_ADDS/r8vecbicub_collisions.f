      subroutine r8vecbicub_collisions(ict,ivec,xvec,yvec,ivd,fvalBR,
     >     fvalBPHI,fvalBZ,fvalER,fvalEPHI,fvalEZ,fvalne,fvalTe,
     >     fvalZeff,nx,xpkg,ny,ypkg,fsplBR,fsplBPHI,fsplBZ,fsplER,
     >     fsplEPHI,fsplEZ,fsplne,fsplTe,fsplZeff,inf2,iwarn,ier)
c
...
c output:
      ...
      REAL*8 fvalne(ivd,*)      ! output array
      REAL*8 fvalTe(ivd,*)    ! output array
      REAL*8 fvalZeff(ivd,*)      ! output array
...
c input:
      ...
      REAL*8 fsplne(0:3,inf2,ny) ! (compact) spline coefficients
      REAL*8 fsplTe(0:3,inf2,ny)! (compact) spline coefficients
      REAL*8 fsplZeff(0:3,inf2,ny) ! (compact) spline coefficients
...
c
     ...
     >     hx,hxi,hy,hyi,fsplEZ,inf2,ny)
      call r8fvbicub(ict,ivec,ivd,fvalne,ix,iy,dxn,dyn,
     >     hx,hxi,hy,hyi,fsplne,inf2,ny)
      call r8fvbicub(ict,ivec,ivd,fvalTe,ix,iy,dxn,dyn,
     >     hx,hxi,hy,hyi,fsplTe,inf2,ny)
      call r8fvbicub(ict,ivec,ivd,fvalZeff,ix,iy,dxn,dyn,
     >     hx,hxi,hy,hyi,fsplZeff,inf2,ny)

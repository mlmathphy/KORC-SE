      subroutine r8vectricub_3DBdB1(ictB,ictE,ivec,xvec,yvec,zvec,ivd,
     >     fvalBR,fvalBPHI,fvalBZ,fvalER,fvalEPHI,fvalEZ,fvalPSIp,
     >     nx,xpkg,ny,ypkg,nz,zpkg,fsplBR,fsplBPHI,fsplBZ,fsplER,
     >     fsplEPHI,fsplEZ,fsplPSIp,inf4,inf5,iwarn,ier)
c
...
! idecl:  explicitize implicit REAL declarations:
      REAL*8 stat
!============
      integer ictB(10)           ! selector:
      integer ictE(10)           ! selector:
...
c output:
      ...
      REAL*8 fvalPSIp(ivd,*)      ! output array
c
...
c input:
      ...
      REAL*8 fsplPSIp(8,inf4,inf5,nz) ! (compact) spline coefficients
c
c output:
...
c
      call r8fvtricub(ictB,ivec,ivd,fvalBR,ix,iy,iz,dxn,dyn,dzn,
     >     hx,hxi,hy,hyi,hz,hzi,fsplBR,inf4,inf5,nz)
      call r8fvtricub(ictB,ivec,ivd,fvalBPHI,ix,iy,iz,dxn,dyn,dzn,
     >     hx,hxi,hy,hyi,hz,hzi,fsplBPHI,inf4,inf5,nz)
      call r8fvtricub(ictB,ivec,ivd,fvalBZ,ix,iy,iz,dxn,dyn,dzn,
     >     hx,hxi,hy,hyi,hz,hzi,fsplBZ,inf4,inf5,nz)
      call r8fvtricub(ictE,ivec,ivd,fvalER,ix,iy,iz,dxn,dyn,dzn,
     >     hx,hxi,hy,hyi,hz,hzi,fsplER,inf4,inf5,nz)
      call r8fvtricub(ictE,ivec,ivd,fvalEPHI,ix,iy,iz,dxn,dyn,dzn,
     >     hx,hxi,hy,hyi,hz,hzi,fsplEPHI,inf4,inf5,nz)
      call r8fvtricub(ictE,ivec,ivd,fvalEZ,ix,iy,iz,dxn,dyn,dzn,
     >     hx,hxi,hy,hyi,hz,hzi,fsplEZ,inf4,inf5,nz)
      call r8fvtricub(ictE,ivec,ivd,fvalPSIp,ix,iy,iz,dxn,dyn,dzn,
     >     hx,hxi,hy,hyi,hz,hzi,fsplPSIp,inf4,inf5,nz)
c

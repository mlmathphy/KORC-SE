...
module EZspline
  ...
  interface EZspline_interp
     ...
     subroutine EZspline_interp3_3DBdB_cloud_r8(spline_oBR, spline_oBPHI, &
          ...
          spline_oER, spline_oEPHI, spline_oEZ, &
     ...
     subroutine EZspline_interp3_3DBdB1_cloud_r8(spline_oBR, spline_oBPHI, &
          ...
          k, p1, p2, p3, fBR, fBPHI, fBZ, fER, fEPHI, fEZ, fPSIp, ier)
       use EZspline_obj
       type(EZspline3_r8) spline_oBR,spline_oBPHI,spline_oBZ
       type(EZspline3_r8) spline_oER,spline_oEPHI,spline_oEZ
     ...
     subroutine EZspline_interp2_FOvars_cloud_r8(spline_oBR, spline_oBPHI, &
          spline_oBZ, spline_oER, spline_oEPHI, spline_oEZ,&
          k, p1, p2, fBR, fBPHI, fBZ, fER, fEPHI, fEZ, ier)
       use EZspline_obj
     ...
     subroutine EZspline_interp2_2DBdB1_cloud_r8(spline_oBR, spline_oBPHI, &
          spline_oBZ, spline_oER, spline_oEPHI, spline_oEZ, spline_oPSIp, &
          k, p1, p2, fBR, fBPHI, fBZ, fER, fEPHI, fEZ, fPSIp, ier)
       use EZspline_obj
       type(EZspline2_r8) spline_oBR,spline_oBPHI,spline_oBZ
       type(EZspline2_r8) spline_oER,spline_oEPHI,spline_oEZ
  ...
  interface EZspline_derivative
     ...
     subroutine EZspline_GCderivative3_cloud_r8(spline_o, k, p1, p2, p3, f, ier)
       use EZspline_obj
       type(EZspline3_r8) spline_o
       integer, intent(in) :: k
       real(ezspline_r8), intent(in) :: p1(k), p2(k), p3(k)
       real(ezspline_r8), intent(out) :: f(k,7)
       integer, intent(out) :: ier
     end subroutine EZspline_GCderivative3_cloud_r8
     ...
     subroutine EZspline_GCderivative2_cloud_r8(spline_o, k, p1, p2, f, ier)
       use EZspline_obj
       type(EZspline2_r8) spline_o
       integer, intent(in) :: k
       real(ezspline_r8), intent(in) :: p1(k), p2(k)
       real(ezspline_r8), intent(out) :: f(k,6)
       integer, intent(out) :: ier
     end subroutine EZspline_GCderivative2_cloud_r8

     subroutine EZspline_GCderivativewE2_cloud_r8(spline_oA, spline_oE, k, p1, p2, fA, fE, ier)
       use EZspline_obj
       type(EZspline2_r8) spline_oA, spline_oE
       integer, intent(in) :: k
       real(ezspline_r8), intent(in) :: p1(k), p2(k)
       real(ezspline_r8), intent(out) :: fA(k,6), fE(k)
       integer, intent(out) :: ier
     end subroutine EZspline_GCderivativewE2_cloud_r8

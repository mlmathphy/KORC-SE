      subroutine r8vecbicub_FOmars(ictA,ict,ivec,xvec,yvec,ivd,fvalA,
     >     fvalBRRe,fvalBPHIRe,fvalBZRe,fvalBRIm,fvalBPHIIm,fvalBZIm,
     >     nx,xpkg,ny,ypkg,fsplA,fsplBRRe,fsplBPHIRe,fsplBZRe,
     >     fsplBRIm,fsplBPHIIm,fsplBZIm,inf2,iwarn,ier)
c
...
c output:
      ...
      REAL*8 fvalBRRe(ivd,*)    ! output array
      REAL*8 fvalBPHIRe(ivd,*)    ! output array
      REAL*8 fvalBZRe(ivd,*)    ! output array
      REAL*8 fvalBRIm(ivd,*)    ! output array
      REAL*8 fvalBPHIIm(ivd,*)    ! output array
...
c input:
      ...
      REAL*8 fsplBRRe(0:3,inf2,ny) ! (compact) spline coefficients
      REAL*8 fsplBPHIRe(0:3,inf2,ny) ! (compact) spline coefficients
      REAL*8 fsplBZRe(0:3,inf2,ny) ! (compact) spline coefficients
      REAL*8 fsplBRIm(0:3,inf2,ny) ! (compact) spline coefficients
      REAL*8 fsplBPHIIm(0:3,inf2,ny) ! (compact) spline coefficients
...
c
     ...
     >     hx,hxi,hy,hyi,fsplA,inf2,ny)
      call r8fvbicub(ict,ivec,ivd,fvalBRRe,ix,iy,dxn,dyn,
     >     hx,hxi,hy,hyi,fsplBRRe,inf2,ny)
      call r8fvbicub(ict,ivec,ivd,fvalBPHIRe,ix,iy,dxn,dyn,
     >     hx,hxi,hy,hyi,fsplBPHIRe,inf2,ny)
      call r8fvbicub(ict,ivec,ivd,fvalBZRe,ix,iy,dxn,dyn,
     >     hx,hxi,hy,hyi,fsplBZRe,inf2,ny)
      call r8fvbicub(ict,ivec,ivd,fvalBRIm,ix,iy,dxn,dyn,
     >     hx,hxi,hy,hyi,fsplBRIm,inf2,ny)
      call r8fvbicub(ict,ivec,ivd,fvalBPHIIm,ix,iy,dxn,dyn,
     >     hx,hxi,hy,hyi,fsplBPHIIm,inf2,ny)

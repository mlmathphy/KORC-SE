...
c input:
      ...
      REAL*8 fsplgradBR(8,inf4,inf5,nz) ! (compact) spline coefficients
      REAL*8 fsplgradBPHI(8,inf4,inf5,nz)! (compact) spline coefficients
      REAL*8 fsplgradBZ(8,inf4,inf5,nz) ! (compact) spline coefficients
      REAL*8 fsplcurlbR(8,inf4,inf5,nz) ! (compact) spline coefficients
      REAL*8 fsplcurlbPHI(8,inf4,inf5,nz)! (compact) spline coefficients
      REAL*8 fsplcurlbZ(8,inf4,inf5,nz) ! (compact) spline coefficients
c
c output:
...
c
     ...
     >     hx,hxi,hy,hyi,hz,hzi,fsplEZ,inf4,inf5,nz)
      call r8fvtricub(ict,ivec,ivd,fvalgradBR,ix,iy,iz,dxn,dyn,dzn,
     >     hx,hxi,hy,hyi,hz,hzi,fsplgradBR,inf4,inf5,nz)
      call r8fvtricub(ict,ivec,ivd,fvalgradBPHI,ix,iy,iz,dxn,dyn,dzn,
     >     hx,hxi,hy,hyi,hz,hzi,fsplgradBPHI,inf4,inf5,nz)
      call r8fvtricub(ict,ivec,ivd,fvalgradBZ,ix,iy,iz,dxn,dyn,dzn,
     >     hx,hxi,hy,hyi,hz,hzi,fsplgradBZ,inf4,inf5,nz)
      call r8fvtricub(ict,ivec,ivd,fvalcurlbR,ix,iy,iz,dxn,dyn,dzn,
     >     hx,hxi,hy,hyi,hz,hzi,fsplcurlbR,inf4,inf5,nz)
      call r8fvtricub(ict,ivec,ivd,fvalcurlbPHI,ix,iy,iz,dxn,dyn,dzn,
     >     hx,hxi,hy,hyi,hz,hzi,fsplcurlbPHI,inf4,inf5,nz)
      call r8fvtricub(ict,ivec,ivd,fvalcurlbZ,ix,iy,iz,dxn,dyn,dzn,
     >     hx,hxi,hy,hyi,hz,hzi,fsplcurlbZ,inf4,inf5,nz)
c

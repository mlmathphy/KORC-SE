...
subroutine EZspline_GCderivativewE2_cloud_r8(spline_oA, spline_oE, &
     & k, p1, p2, fA, fE, ier)
  use EZspline_obj
  implicit none
  ...
  call r8vecbicub_wE(ictA, ictE, k, p1, p2, &
       & k, fA, fE, &
       & spline_oA%n1, spline_oA%x1pkg(1,1), &
       & spline_oA%n2, spline_oA%x2pkg(1,1), &
       & spline_oA%fspl(1,1,1), spline_oE%fspl(1,1,1), spline_oA%n1, &
       & iwarn, ifail)
...
subroutine EZspline_GCderivative2_cloud_r8(spline_o, &
     & k, p1, p2, f, ier)
  use EZspline_obj
  implicit none
  type(EZspline2_r8) spline_o
...
subroutine EZspline_GCderivative3_cloud_r8(spline_o, &
     & k, p1, p2, p3, f, ier)
  use EZspline_obj
  implicit none
  type(EZspline3_r8) spline_o

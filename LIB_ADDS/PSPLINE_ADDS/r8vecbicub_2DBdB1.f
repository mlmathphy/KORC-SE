      subroutine r8vecbicub_2DBdB1(ictB,ictE,ivec,xvec,yvec,ivd,
     >     fvalBR,fvalBPHI,fvalBZ,
     >     fvalER,fvalEPHI,fvalEZ,fvalPSIp,
     >     nx,xpkg,ny,ypkg,
     >     fsplBR,fsplBPHI,fsplBZ,
     >     fsplER,fsplEPHI,fsplEZ,fsplPSIp,inf2,iwarn,ier)
c
...
!============
      integer ictB(6)            ! selector:
      integer ictE(6)            ! selector:
...
c input:
      ...
      REAL*8 fsplPSIp(0:3,inf2,ny) ! (compact) spline coefficients      
c     
c output:
...
c
      call r8fvbicub(ictB,ivec,ivd,fvalBR,ix,iy,dxn,dyn,
     >     hx,hxi,hy,hyi,fsplBR,inf2,ny)
      call r8fvbicub(ictB,ivec,ivd,fvalBPHI,ix,iy,dxn,dyn,
     >     hx,hxi,hy,hyi,fsplBPHI,inf2,ny)
      call r8fvbicub(ictB,ivec,ivd,fvalBZ,ix,iy,dxn,dyn,
     >     hx,hxi,hy,hyi,fsplBZ,inf2,ny)   
      call r8fvbicub(ictE,ivec,ivd,fvalER,ix,iy,dxn,dyn,
     >     hx,hxi,hy,hyi,fsplER,inf2,ny)
      call r8fvbicub(ictE,ivec,ivd,fvalEPHI,ix,iy,dxn,dyn,
     >     hx,hxi,hy,hyi,fsplEPHI,inf2,ny)
      call r8fvbicub(ictE,ivec,ivd,fvalEZ,ix,iy,dxn,dyn,
     >     hx,hxi,hy,hyi,fsplEZ,inf2,ny)
      call r8fvbicub(ictE,ivec,ivd,fvalPSIp,ix,iy,dxn,dyn,
     >     hx,hxi,hy,hyi,fsplPSIp,inf2,ny)
c
      return
      end
